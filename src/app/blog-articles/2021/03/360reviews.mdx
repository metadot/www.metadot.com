export const blog = {
  ...
  image: "/blog/360reviews.svg",
  alt: "Woman sitting on top of a computer looking at reviews",
  author: "Catherine Mulder",
  description:
    "Why 360-degree reviews outperform traditional evaluations, and how Metadot runs full-circle feedback across every level of the organization.",
  draft: false,
};
...
[phttps://hbr.org/2014/01/your-employees-want-the-negative-feedback-you-hate-to-give]
