export const blog = {
  ...
  image: "/blog/buddysystem.svg",
  alt: "Two coworkers working together on a project",
  author: "Catherine Mulder",
  description:
    "Metadot's buddy system pairs new hires with a veteran teammate to simplify remote onboarding and accelerate time-to-productivity.",
  draft: false,
};
