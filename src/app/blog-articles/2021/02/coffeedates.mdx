export const blog = {
  ...
  image: "/blog/coffeedates.svg",
  alt: "Man sitting next to large coffee cup",
  author: "Catherine Mulder",
  description:
    "How Metadot's virtual coffee date program strengthened team connections and communication skills across a distributed workforce.",
  draft: false,
};
